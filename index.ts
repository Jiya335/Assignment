...
let person1 = "jiya";
console.log(
"Hello!"+"   "+person1+ " would you like to learn some typescript?"
);
...
function toTitleCase(string: string) {
    return string.replace(/\b\w/g, (word: string) => word.toUpperCase());}
console.log("Titlecase:", toTitleCase(personName));

//Question no 4:
console.log(
  'Hazrat Muhammad (SAW) ne farmaya, "Kindness is a mark of faith, and whoever is not kind has no faith."'
);

//Question no 5:
let famous_person: string = "Quaid-e-Azam Muhammad Ali Jinnah";
let quotemessage: string = `A quote from ${famous_person}: "The power of women is greater than the sword and the pen."`;
console.log(quotemessage);

//Question no 6:
let nameWithWhitespace: string = "\tALEEB \n";
...
//Question no 9:
const myfavoriteNumber: number = 25; // Your favorite number
const Amessage: string = `My favorite number is ${myfavoriteNumber}.`;
...
const newInvitee: string = "Aariz";
guestList.push(newInvitee);
// Print a second set of invitation messages
guestList.forEach(person => {console.log(`Dear ${person},\nYou are invited to dinner.\Sincerely, [Butt house]`);});

//Question no 16:
let aguestList: string[] =  ["Zainab", "Rawish", "Arham"];
// Print the original set of invitation messages
for (const person of guestList) {console.log(`Dear ${person}, please come to dinner.`);}
...
for (let i = 0; i < guestList.length; i++) {console.log(`Dear ${guestList[i]}, please come to dinner.`);}

//Question no 17:
let nguestList: string[] = ["zaino", "rawish", "arham", "aariz", "ahaan", "rohan"];
// Print the original set of invitation messages
for (const person of guestList) {console.log(`Dear ${person}, please come to dinner.`);}
...
for (const person of guestList) {console.log(`Dear ${person}, you're still invited to dinner.`);}
...
let places: string[] = ["Paris", "istabul", "london", "Dubai", "Tokyo"];
...
let dinnerGuests: string[] = ["Shoaib", "Rawish", "Aleeb", "rohan", "ahaan"];
...
//Question no 25:
let thealien_color: string = 'green';
if (thealien_color === 'green') {console.log("Congratulations! You just earned 5 points.");}
...
if (alienColor === 'green') {console.log("You just earned 5 points for shooting the green alien!");}
else {console.log("You just earned 10 points!");}
...
if (favoriteFruits.includes('orange')) {console.log("You really like oranges!");}
if (favoriteFruits.includes('grapes')) {console.log("You really like grapes!");}
else {console.log("Grapes are not one of my favorite fruits.");}
if (favoriteFruits.includes('strawberry')) {
console.log("You really like strawberries!");}
else {console.log("strawberries are not one of my favorite fruits.");}

//Question no 30:
let usernames: string[] = ['admin', 'atif', 'lalli', 'ali', 'saad'];
...
//Question no 31:
let users: string[] = ["Jiyu", "Manno", "sami"];
if (users.length === 0) {
console.log("We need to find some users!");} else {
users = []; // Removing all usernames from the array
console.log("All usernames have been removed.");}

//Question no 32:
// current users
const current_users: string[] = ["jia", "fatima", "", "Makiya", "hani"];
//  new users
const new_users: string[] = ["arif", "aly", "soni", "maary", "jon"];
...
new_users.forEach(username => {
 if (checkUsernameAvailability(username)) {console.log(`Username '${username}' is available.`);
  } else {console.log(`Username '${username}' is already taken. Please choose a different one.`);}});
...
const favoritePizzas: string[] = ["chessy", "saucy", "BBQ Chicken"];
...
//Question no 37:
function newmake_shirt(size: string = "large", message: string = "I love TypeScript"): void 
{console.log(`You have ordered a ${size}-sized shirt with the message: "${message}".`);}
...
const album3: Album = make_album("Artist3", "Album Title 3");
...
const magicianNames: string[] = ["Jaweria", "Samreen", "Rashid", "Moon"];
...
function make_great(magicians: string[]): string[] {
  ...
  return magicians;}
// Array of magician's names
let themagicianNames: string[] = ["Jaweria", "Samreen", "Rashid", "Moon"];
...
//Question no 43:
function newshow_magicians(magicians: string[]): void {
  magicians.forEach(magician => {
      console.log(magician); });}
function newmake_great(magicians: string[]): string[] {
  const greatMagicians: string[] = [];
  for (let i = 0; i < magicians.length; i++) {
  greatMagicians.push("the Great " + magicians[i]);}
  return greatMagicians;}
// Array of magician's names
const newmagicianNames: string[] = ["Jaweria", "Samreen", "Rashid", "Moon"];
// Displaying original magician names
console.log("Original Magician Names:");
show_magicians(magicianNames);
...
const myCar: Car = createCar("mercedes", "Benz S-Class", ["color", "jet black"], ["year", "2022"]);
